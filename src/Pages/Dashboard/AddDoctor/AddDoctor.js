...
const AddDoctor = () => {
    ...
    const { data: specialties = [] } = useQuery({
        queryKey: ['specialty'],
        queryFn: async () => {
            const res = await fetch(`https://doctors-portal-server-eight-lilac.vercel.app/appointmentSpecialty`)
        ...
        fetch(`https://api.imgbb.com/1/upload?key=${imageHost}`, {
            ...
            .then(imgData => {
                if (imgData.success) {
                    ...
                    fetch(`https://doctors-portal-server-eight-lilac.vercel.app/doctors`, {
                        method: "POST",
                        headers: {
